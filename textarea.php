  ...
  <link rel="stylesheet" href="def.css?<?php echo time(); ?>">
	...
	<script>
		...
		function guardaycierra() {
			...
			source = '<textarea id="valor" name="valor" width="100%" height="70%" style="width:95%;height:70%;border:2px dotted orange;">'+document.getElementById("valor").value+'</textarea>';
